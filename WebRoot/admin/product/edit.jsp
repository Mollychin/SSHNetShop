		...
		<table cellSpacing="1" cellPadding="5" width="100%" align="center"
				...
				<td class="ta_01" bgColor="#ffffff"><select
					name="categorySecond.csid">
						<s:iterator var="cs" value="cslist">
							...
							<option value="<s:property value="#cs.csid"/>" <s:if test="#cs.csid==model.categorySecond.csid">selected</s:if>><s:property
			...
			<tr>
				...
				<td class="ta_01" bgColor="#ffffff"><textarea rows="5"
						cols="20" name="pdesc" ><s:property value="model.pdesc"/></textarea></td>
			</tr>
			<tr>
				<td width="18%" align="center" bgColor="#f5fafe" class="ta_01">
					商品图片：</td>
