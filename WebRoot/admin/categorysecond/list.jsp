...
&#28155;&#21152;
					...
					<tr align="center">
						<td class="ta_01" align="center" bgColor="#afd1f3">
							...
							<a href="${pageContext.request.contextPath}/adminCategorySecond_findAll.action?page=1" class="firstPage">&nbsp;首页</a>
							<a href="${pageContext.request.contextPath}/adminCategorySecond_findAll.action?page=<s:property value="pageBean.page-1"/>" class="firstPage">&nbsp;上一页</a>
							</s:if>
							<s:if test="pageBean.page!=#i">
							<a href="${pageContext.request.contextPath}/adminCategorySecond_findAll.action?page=<s:property value="pageBean.page+1"/>" class="firstPage">&nbsp;下一页</a>
							<a href="${pageContext.request.contextPath}/adminCategorySecond_findAll.action?page=<s:property value="pageBean.totalPage"/>" class="firstPage">&nbsp;尾页</a>
						</s:if>
						</td>
					</tr>
				</TBODY>
